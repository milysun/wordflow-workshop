...
*Send ~7 days before. Copy the body below and personalise. Placeholders in ⟨angle brackets⟩; fill before sending.*
...
- **Link:** ⟨Zoom link⟩ (same link for both sessions)
- Questions during Session 1: drop them in chat; we'll take them at natural pauses.
- Session 2: mic-on questions welcome; helpers will be in the meeting to assist ⟨adjust if no helpers⟩.
